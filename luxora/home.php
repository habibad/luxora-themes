...
set_query_var(
	...
	array(
		...
		'title'    => get_the_title( get_option( 'page_for_posts' ) ) ? get_the_title( get_option( 'page_for_posts' ) ) : __( 'The Journal', 'luxora' ),
		'subtitle' => __( 'Editorials, styling notes, and dispatches from the maison.', 'luxora' ),
	)
);
